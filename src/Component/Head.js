  ...
  return (
    <div className="grid grid-flow-col p-3 m-2 shadow-lg">
      ...
      <div className="col-span-10">
        <div>
          <input
            className="w-1/2 px-10 border border-gray-500 p-1 rounded-l-full"
            type="text"
            value={searchQuery}
          ...
          />
          <button className="border border-gray-500 py-1 px-4 bg-gray-100 rounded-r-full">
            🔍
          </button>
        </div>
        {showSuggestions && (
          <div className="fixed bg-white py-2 px-2 w-[31rem] shadow-lg rounded-lg border bg-gray-100">
            <ul>
              {suggestion.map((s) => (
